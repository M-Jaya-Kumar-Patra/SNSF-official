                    ...
                    <div className='flex-grow h-full bg-white p-5 shadow-lg text-black'>
                        ...
                        <div className='w-full bg-slate-100 p-2 flex justify-between items-center rounded'>
                            ...
                            <div className='flex items-center gap-2'>
                                ...
                                >
                                    <MenuItem
                                        onClick={() => handleSortBy('name', 'asc', prdData, 'Name, A to Z')}
                                    >
                                        Name, A to Z
                                    </MenuItem>

                                    <MenuItem
                                        onClick={() => handleSortBy('name', 'desc', prdData, 'Name, Z to A')}
                                    >
                                        Name, Z to A
                                    </MenuItem>

                                    <MenuItem
                                        onClick={() => handleSortBy('price', 'asc', prdData, 'Price, low to high')}
                                    >
                                        Price, Low to High
                                    </MenuItem>

                                    <MenuItem
                                        onClick={() => handleSortBy('price', 'desc', prdData, 'Price, high to low')}
                                    >
                                        Price, High to Low
                                    </MenuItem>
                        ...
                        <div className="flex justify-center items-center mt-5">
                            <div className="w-full grid sm:grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 2xl:grid-cols-4 gap-4 mb-5 place-items-center relative z-0 overflow-visible">
                                {console.log("productsData", prdData)}
                                {
                                    prdData
                                                            ...
                                                            onClick={() => {
                                                                if (isLogin) {
                                                                    if (userData?.shopping_cart?.some(item => item === String(prd._id))) {
                                                                        ...
                                                                        console.log("t5ttttttttttttttttttttttttttttttttttttttttktttttttttttttttttttttttttttttttttttttt", userData?._id)
