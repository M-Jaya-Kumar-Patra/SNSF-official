  ...
  return (
    <main className="max-w-4xl mx-auto p-8 bg-white rounded-xl shadow-lg border-t-4 border-slate-900 my-12">
      ...
      <section className="text-gray-700 space-y-4">
        ...
        <p>
          Unauthorized use of any material from this website may violate
          copyright laws and could result in legal action.
        </p>
        <p>
          For permissions or inquiries, please contact us at:{" "}
          <a
